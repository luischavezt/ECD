const config = {
    A: { equipos: ["Mexico", "Sudafrica", "Corea del Sur", "Rep. Checa"], partidos: [
        {fecha: "11 jun 14:00 - MEXICO", e1: "Mexico", e2: "Sudafrica"}, {fecha: "11 jun 21:00 - GUADALAJARA", e1: "Corea del Sur", e2: "Rep. Checa"}, {fecha: "18 jun 20:00 - GUADALAJARA", e1: "Mexico", e2: "Corea del Sur"}, {fecha: "18 jun 11:00 - ATLANTA", e1: "Rep. Checa", e2: "Sudafrica"}, {fecha: "24 jun 20:00 - MEXICO", e1: "Mexico", e2: "Rep. Checa"}, {fecha: "24 jun 20:00 - MONTERREY", e1: "Sudafrica", e2: "Corea del Sur"}]},
...
function init() {
    // 1. Generar los partidos para cada grupo dinámicamente
    ...
    // 2. Actualizar todo al cargar para que las tablas no aparezcan vacías
    actualizarTodo();
}

function mostrarSeccion(idSeccion, btnElement) {
    // 1. Ocultar TODO: Grupos, Secciones y la Bienvenida
...
function calcular(letra) {
    ...
    // Buscamos el contenedor específico de los partidos de este grupo
    ...
    for (let i = 0; i < inputs.length; i += 2) {
        ...
        if (val1 !== "" && val2 !== "") {
            // Asegúrate de que tus inputs en el HTML tengan los atributos data-e1 y data-e2
