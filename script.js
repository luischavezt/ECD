...
function init() {
    ...
    // 2. Cargar valores de Fases Finales (corregido para evitar errores)
...
function mostrarSeccion(idSeccion, btnElement) {
    ...
    // 2. Lógica de botones de limpieza
    ...
    // 4. Resaltar el botón activo (o limpiar si es bienvenida)
